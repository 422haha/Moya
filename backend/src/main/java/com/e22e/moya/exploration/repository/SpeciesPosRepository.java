...
public interface SpeciesPosRepository extends JpaRepository<SpeciesPos, Long> {
    ...
    @Query(value = "SELECT sp.*, " +
        ...
        "LIMIT 1",
        nativeQuery = true)
    Optional<SpeciesPos> findByParkSpeciesAndPos(@Param("parkSpecies") ParkSpecies parkSpecies, @Param("point") Point point);
}
