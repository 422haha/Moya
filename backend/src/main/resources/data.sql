...
VALUES ('강아지풀', 'Setaria viridis', '강아지 꼬리처럼 복슬복슬 귀여운 강아지풀', 'foxtail.jpg'),
       ...
       ('나비', 'butterfly', '다양한 색과 모양을 가진 아름다운 날개를 펼치며 꽃가루를 모으는 곤충', 'test-camera.png'),
       ('잠자리', 'dragonfly', '빠른 비행과 날렵한 체형을 가진 곤충으로 주로 습지나 물가에서 볼 수 있음', 'test-camera.png'),
       ('사슴벌레', 'stag beetle', '커다란 뿔과 강력한 턱을 가진 곤충으로, 주로 숲 속에서 서식', 'test-camera.png');
